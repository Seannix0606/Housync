...
<head>
    ...
    <title>Add New Apartment - Housesync</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="content-header">
                ...
                <p>Create a new apartment property</p>
            </div>
            ...
            <div class="form-container">
                <form method="POST" action="{{ route('landlord.store-apartment') }}" class="apartment-form">
                    @csrf
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="total_units" name="total_units" value="{{ old('total_units') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" rows="4" 
                                      placeholder="Describe the apartment complex, its features, and location benefits">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="amenities-grid">
                            ...
                            <div class="amenity-item">
                                ...
                                <label for="elevator"><i class="fas fa-arrows-alt-v"></i> Elevator</label>
                            </div>
                            <div class="amenity-item">
                            ...
                            <div class="amenity-item">
                                ...
                                <label for="pool"><i class="fas fa-swimming-pool"></i> Pool</label>
                            </div>
                            <div class="amenity-item">
                                <input type="checkbox" id="garden" name="amenities[]" value="garden">
                                <label for="garden"><i class="fas fa-seedling"></i> Garden</label>
                            </div>
                            <div class="amenity-item">
                            ...
                            <div class="amenity-item">
                                <input type="checkbox" id="ac" name="amenities[]" value="air_conditioning">
                            ...
                            <div class="amenity-item">
                                ...
                                <label for="balcony"><i class="fas fa-home"></i> Balcony</label>
                            </div>
                            <div class="amenity-item">
                                <input type="checkbox" id="storage" name="amenities[]" value="storage">
                                <label for="storage"><i class="fas fa-box"></i> Storage</label>
                            </div>
                            <div class="amenity-item">
                                <input type="checkbox" id="playground" name="amenities[]" value="playground">
                                <label for="playground"><i class="fas fa-child"></i> Playground</label>
                            </div>
                        </div>
                    </div>
